...
class DashboardUpdater:
    ...
    def calculate_metric_trends(self, current_metrics: Dict[str, Any]) -> Dict[str, Any]:
        ...
        previous = self.historical_data[-2] if len(self.historical_data) >= 2 else self.historical_data[-1]
    ...
    def calculate_trend(self, current: float, previous: float, inverse: bool = False) -> str:
    ...
    def calculate_trends(self, days: int) -> Dict[str, Any]:
        ...
        coverage_rates = [data['overview']['coverage_percentage'] for data in period_data]
    ...
    def calculate_overall_trend(self, values: List[float], inverse: bool = False) -> str:
    ...
    def broadcast_metrics_update(self, metrics: Dict[str, Any]):
        ...
        if self.connected_clients:
            ...
            self.logger.debug(f"Broadcasted metrics to {len(self.connected_clients)} clients")
    ...
    def get_quality_gates_status(self) -> Dict[str, Any]:
        """Get current quality gates status."""
        return self.current_metrics.get('quality_gates', {
