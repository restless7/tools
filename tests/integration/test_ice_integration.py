        ...
        with patch('ice_pipeline.ingestion.os.getenv') as mock_getenv:
            ...
            with patch('ice_pipeline.ingestion.Path.exists', return_value=True):
                ...
                with patch('ice_pipeline.api.process_excel_conversion') as mock_convert:
                    ...
                    convert_response = api_client.post("/convert-excel", json=conversion_request)
                ...
                with patch('ice_pipeline.ingestion.asyncio.create_subprocess_exec') as mock_process:
                    mock_subprocess = AsyncMock()
                    mock_subprocess.returncode = 0
                    mock_subprocess.communicate.return_value = (b'Integration test successful', b'')
