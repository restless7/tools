...
class ICEIngestionPipeline:
    ...
    def __init__(self, mode: str = 'auto'):
        ...
        self.local_ingestion_dir = os.getenv('LOCAL_INGESTION_DIR', '/mnt/ice-ingestion-data')
    ...
    def _log_to_database(self, result: Dict[str, Any], start_time: datetime, end_time: datetime):
