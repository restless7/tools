...
class StorageAdapter(ABC):
    ...
    @abstractmethod
    def get_metadata(self, file_path: str, student_id: Optional[str] = None) -> DocumentMetadata:
...
class LocalStorageAdapter(StorageAdapter):
    ...
    def _infer_document_type(self, file_name: str, student_id: Optional[str] = None) -> str:
        """
    ...
    def get_metadata(self, file_path: str, student_id: Optional[str] = None) -> DocumentMetadata:
        ...
        try:
            ...
            logger.debug(f"Extracted metadata for {path.name}: {document_type}, {file_size} bytes")
    ...
    def upload(self, file_path: str, destination: str) -> Dict[str, Any]:
        ...
        """
        logger.info(f"Upload operation called for local storage (no-op): {file_path} -> {destination}")
    ...
    def delete(self, file_path: str) -> bool:
        ...
        """
        logger.warning(f"Delete operation not supported in local storage mode: {file_path}")
        return False
