...
class TestLogger:
    ...
    def log_suite_end(self, results: Dict[str, Any]):
        ...
        self.logger.info(f"✅ Passed: {results['passed']} ({results['pass_rate']:.1f}%)")
    ...
    def log_performance(self, test_name: str, metrics: Dict[str, float]):
        ...
        self.logger.info(
            ...
            extra={'test_name': test_name, **metrics}
        )
    ...
    class LoggingPlugin:
        ...
        def pytest_runtest_protocol(self, item, nextitem):
            ...
            if hasattr(result, 'passed') and result.passed:
                ...
                logger.log_test_end(test_name, 'FAILED', duration, 
...
if __name__ == "__main__":
    ...
    logger.log_coverage({
        ...
        'ice_pipeline.ingestion': {'coverage': 94.0, 'statements': 108, 'missing': 6}
    })
